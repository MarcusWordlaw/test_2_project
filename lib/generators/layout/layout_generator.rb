class LayoutGenerator < Rails::Generators::Base
  ...
  def generate_views
    template "index_view.template", "app/views/#{file_name.pluralize}/index.html.erb"
    template "edit_view.template", "app/views/#{file_name.pluralize}/edit.html.erb"
    template "new_view.template", "app/views/#{file_name.pluralize}/new.html.erb"
    template "show_view.template", "app/views/#{file_name.pluralize}/show.html.erb"
  end
